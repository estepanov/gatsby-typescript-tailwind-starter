    ...
    <Container>
      <div css={tw`container`}>
        ...
        <a
          ...
          tw="bg-white font-bold text-purple-600 rounded-full py-4 px-8 shadow-lg uppercase tracking-wider hover:shadow-sm hover:text-purple-100 hover:bg-purple-600 focus:outline-none focus:shadow-sm focus:text-purple-100 focus:bg-purple-800 transition duration-500 ease-in-out"
        >
          Star on GitHub
        </a>
      </div>
